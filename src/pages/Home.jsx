  ...
  return (
    <>
      ...
      <>
        ...
        <div className="flex flex-row items-start justify-start shrink-0 [debug_commit:bf4bc93] max-w-[169%]">
        ...
        <div className="w-[1263.5px] h-[386.6px] absolute !m-[0] top-[900px] left-[-60.5px] max-w-full text-center text-29xl mq825:top-[400px]">
